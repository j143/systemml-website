        ...
        stage('Prepare') {
            steps {
                script {
                    ...
                    // Setup directory structure for generated content in this case `content/`
        ...
        stage('Build') {
            steps {
                script {
                    ...
                    // working with gulp
                    WithEnv(["PATH+JEKYLL=${env.JEKYLL_DIR}/bin"]) {
                        sh "gulp"
                    }
                }
            }
        ...
        stage('Deploy') {
            ...
            steps {
                script {
                    ...
                    // Remove the content of the target asf-site branch and replace it with the content of
                    // temp folder in this case `_site`
                    sh """
                        rm -rf ${WORKSPACE}/content
                        git rm -r --cached content/*
                        mkdir -p ${WORKSPACE}/content
